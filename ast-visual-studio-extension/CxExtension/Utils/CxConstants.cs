namespace ast_visual_studio_extension.CxExtension.Utils
{
    internal class CxConstants
    {
        ...
        /************ NOTIFICATIONS ************/
        public static string NOTIFY_FILE_NOT_FOUND => "File {0} not found. Please ensure you are in the correct scan.";
        ...
        /************ TOOLBAR ************/
        public static string TOOLBAR_SELECT_PROJECT => "Project";
        public static string TOOLBAR_SELECT_BRANCH => "Branch";
        public static string TOOLBAR_SELECT_SCAN => "Scan";
        ...
        /************ TRIAGE ************/
        public static string TRIAGE_COMMENT_PLACEHOLDER => "Notes (Optional or required based on tenant configuration)";
        ...
        /************ SCANNING ************/
        public static string STATUS_CREATING_SCAN => "Creating scan...";
        public static string STATUS_CREATING_SCAN_FAILED => "Checkmarx: Failed creating scan";
        public static string STATUS_FORMAT_CREATED_SCAN => "Scan created with id {0}";
        public static string STATUS_FORMAT_POLLING_SCAN => "Scan with id {0} still running...";
        public static string STATUS_FORMAT_POLLING_SCAN_FAILED => "Checkmarx: Failed polling scan {0}";
        public static string STATUS_FORMAT_CANCELLING_SCAN => "Canceling scan with id {0}";
        public static string STATUS_FORMAT_FINISHED_SCAN => "Checkmarx scan completed successfully";
        ...
        public static string PROJECT_DOES_NOT_MATCH => "Git project doesn't match the selected Checkmarx project. Do you want to scan anyway?";
