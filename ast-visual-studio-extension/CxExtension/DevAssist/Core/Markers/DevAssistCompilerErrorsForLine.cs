...
namespace ast_visual_studio_extension.CxExtension.DevAssist.Core.Markers
{
    ...
    /// "Also on this line (Compiler / VS):" combined with DevAssist findings.
    /// </summary>
    internal static class DevAssistCompilerErrorsForLine
    {
        /// <summary>
        ...
        public static IReadOnlyList<string> GetErrorsForLine(string filePath, int line1Based)
        {
            ...
            try
            {
                ...
                for (int i = 1; i <= count; i++)
                {
                    ...
                    {
                        System.Diagnostics.Debug.WriteLine($"DevAssist: GetErrorsForLine item {i}: {ex.Message}");
                    }
                }
            ...
            {
                System.Diagnostics.Debug.WriteLine($"DevAssist: GetErrorsForLine failed: {ex.Message}");
                return Array.Empty<string>();
            }
        }
