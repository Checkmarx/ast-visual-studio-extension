    ...
    internal sealed class FixWithCxOneAssistSuggestedAction : ISuggestedAction
    {
        ...
        public void Invoke(CancellationToken cancellationToken)
        {
            ...
            System.Windows.Threading.Dispatcher.CurrentDispatcher.BeginInvoke(new Action(() =>
            {
                ...
                {
                    DevAssistErrorHandler.LogAndSwallow(ex, "FixWithCxOneAssistSuggestedAction.Invoke");
                }
            }));
        }
    ...
    internal sealed class ViewDetailsSuggestedAction : ISuggestedAction
    {
        ...
        public void Invoke(CancellationToken cancellationToken)
        {
            ...
            System.Windows.Threading.Dispatcher.CurrentDispatcher.BeginInvoke(new Action(() =>
            {
                ...
                {
                    DevAssistErrorHandler.LogAndSwallow(ex, "ViewDetailsSuggestedAction.Invoke");
                }
            }));
        }
