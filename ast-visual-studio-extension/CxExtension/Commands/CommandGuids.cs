...
namespace ast_visual_studio_extension.CxExtension.Commands
{
    ...
    internal static class CommandGuids
    {
        ...
        /// </summary>
        public static readonly Guid ErrorListCommandSetGuid = new Guid("b7e8b6e3-8e3e-4e3e-8e3e-8e3e8e3e8e40");

        /// <summary>
        /// GUID for Show Findings Window command set.
        /// Defined in CxWindowPackage.vsct as guidShowFindingsWindowCommandSet.
        /// </summary>
        public static readonly Guid ShowFindingsWindowCommandSetGuid = new Guid("a6e8b6e3-8e3e-4e3e-8e3e-8e3e8e3e8e3f");
    }
}
